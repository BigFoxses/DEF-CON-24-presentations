# Amro Abdelgawad
# The Remote Metamorphic Eninge - Sample3_isDebugged2
...
while 1:
    ...
    asm,key = gencode(is_debugged2_asm)
    ...
    # Responses should decrypt to the same exact value across different mutated challenges of the same code/function.
